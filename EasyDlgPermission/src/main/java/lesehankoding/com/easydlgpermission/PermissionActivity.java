...
public class PermissionActivity extends AppCompatActivity {
    ...
    public static int PERMISSION_TYPE_MULTI = 2;
    ...
    private void showPermissionDialog() {
        ...
        if (mStyleId == -1) {
            mStyleId = R.style.EasyPermissionDialogStyle;
            mFilterColor = getResources().getColor(R.color.EasycolorDlgPrimary);
        }
            ...
            case REQUEST_CODE_MUTI_SINGLE:
                if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
                    ...
                    try {
                        ...
                        @SuppressLint("StringFormatMatches") String title = String.format(getString(R.string.permission_title_error), name);
