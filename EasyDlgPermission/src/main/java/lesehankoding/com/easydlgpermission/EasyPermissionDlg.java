...
public class EasyPermissionDlg {
    ...
    public static EasyPermissionDlg create(Context context) {
        return new EasyPermissionDlg(context);
    }

    public EasyPermissionDlg(Context context) {
        mContext = context;
        mNormalPermissionNames = mContext.getResources().getStringArray(R.array.permissionNames);
    }

    public EasyPermissionDlg title(String title) {
        mTitle = title;
        return this;
    }

    public EasyPermissionDlg msg(String msg) {
        mMsg = msg;
        return this;
    }

    public EasyPermissionDlg permissions(List<PermissionItem> permissionItems) {
        mCheckPermissions = permissionItems;
        return this;
    }

    public EasyPermissionDlg filterColor(int color) {
        mFilterColor = color;
        return this;
    }

    public EasyPermissionDlg animStyle(int styleId) {
        mAnimStyleId = styleId;
        return this;
    }

    public EasyPermissionDlg style(int styleResIdsId) {
